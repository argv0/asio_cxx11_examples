#ifndef __PACKED_MESSAGE_HPP_
#define __PACKED_MESSAGE_HPP_
...
class packed_message 
{
public:

    typedef std::shared_ptr<MessageType> message_ptr;

    packed_message(message_ptr msg = message_ptr())
        : m_msg(msg)
    {}

    void set_msg(message_ptr msg)
    {
        m_msg = msg;
    }
